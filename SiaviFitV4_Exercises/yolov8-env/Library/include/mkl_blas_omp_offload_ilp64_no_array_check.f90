...
module onemkl_blas_omp_offload_ilp64_no_array_check
  ...
  interface
     ...
     subroutine cgemm3m ( transa, transb, m, n, k, alpha, a, lda,      &
       ...
       !dec$ attributes no_arg_check       :: c
       complex,intent(inout)               :: c( ldc, * )
       !$omp  declare variant( cgemm3m:mkl_blas_cgemm3m_omp_offload_ilp64 ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     subroutine zgemm3m ( transa, transb, m, n, k, alpha, a, lda,      &
       ...
       !dec$ attributes no_arg_check      :: c
       complex*16,intent(inout)           :: c( ldc, * )
       !$omp  declare variant( zgemm3m:mkl_blas_zgemm3m_omp_offload_ilp64 ) match( construct={target variant dispatch}, device={arch(gen)} )
    ...
    subroutine daxpy_batch_strided ( n, alpha, x, incx, stridex,   &
     ...
     subroutine zgemm3m_batch ( transa, transb, m, n, k, alpha, a, lda,        &
       ...
       integer(KIND=C_INTPTR_T),intent(in)    :: a( * ), b( * )
       integer(KIND=C_INTPTR_T),intent(inout) :: c( * )
       !$omp  declare variant( zgemm3m_batch:mkl_blas_zgemm3m_batch_omp_offload_ilp64 ) match( construct={target variant dispatch}, device={arch(gen)} )
     ...
     subroutine cgemm3m_batch ( transa, transb, m, n, k, alpha, a, lda,        &
       ...
       integer(KIND=C_INTPTR_T),intent(in)    :: a( * ), b( * )
       integer(KIND=C_INTPTR_T),intent(inout) :: c( * )
       !$omp  declare variant( cgemm3m_batch:mkl_blas_cgemm3m_batch_omp_offload_ilp64 ) match( construct={target variant dispatch}, device={arch(gen)} )
